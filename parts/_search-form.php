...
<div class="bg-blue-rounded max-1245">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div class="searchHomeContent">
                        <div class="well well-lg clearfix" role="search">
                            ...
                            <div class="modal fade my-5" role="dialog" id="advancedSearchModal" tabindex="-1" aria-labelledby="advancedSearchLabel" aria-hidden="true">
                ...
                <div class="col-md-5 position-relative desktop-only">
