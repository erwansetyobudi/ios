...
<div class="flex h-screen w-full" id="visitor-counter" style="background: rgba(0,0,0,0.3)">
    <div class="bg-white w-full md:w-1/3 px-8 pt-4 pb-3 flex flex-col justify-between relative">
    <!-- Tambahkan gambar 3D di atas form -->
    <div class="flex justify-center">
        <img src="template/ios/assets/images/visitor.png" alt="Illustration" class="w-full object-contain drop-shadow-2xl marginvisitor transform transition duration-500 hover:scale-105">
    </div>
    
    <div class="bg-visitor p-3 rounded">
        ...
        <form class="mt-4" @submit.prevent="onSubmit">
            <div class="form-group">
                ...
                <input v-model="memberId" ref="memberId" autofocus type="text" class="form-control bg-white" style="border-radius: 5px;" id="exampleInputEmail1"
       aria-describedby="emailHelp" placeholder="<?= __('Enter your member ID')?>"><br>
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1"><?= __('Institution')?></label>
                <input v-model="institution" type="text" class="form-control bg-white" id="exampleInputPassword1"
                       placeholder="<?= __('Enter your institution')?>"> <br>
